...
static struct regval_list sensor_10bit_20fps_regs[] = {
/* ALL PIXEL  - 720Mbps - 24MHZ - 4K 20fps */
	{0x3000, 0x01},/* stanby */
	{0x3001, 0x00},
	{0x3008, 0x54},
	{0x300A, 0x3B},
...
static struct sensor_win_size sensor_win_sizes[] = {
	 ...
	 .gain_min = 1<<4,
	 .gain_max = 5631<<4,
	 .regs = sensor_10bit_20fps_regs,
	 .regs_size = ARRAY_SIZE(sensor_10bit_20fps_regs),
	 .set_size = NULL,
	 },
#else
	...
	{  /* 1920*1080 30fps 10bit */
	 ...
	 .regs_size = ARRAY_SIZE(sensor_10bit_1080p_regs),
	 .set_size = NULL,
	 },
	 /*
	 {  /* 60fps 10bit
